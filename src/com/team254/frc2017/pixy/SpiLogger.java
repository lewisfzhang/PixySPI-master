...
public class SpiLogger {
	...
	public void startLogging() throws Exception {
		...
		// System.out.println("Rx byte ("+i+"): " +
		// Integer.toString(Byte.toUnsignedInt(d[0]), 16));
		// }
		...
		// for (byte b: d)
		// {
		// System.out.println("rx byte: " + Integer.toString(Byte.toUnsignedInt(b),
		// 16));
		// }
		// System.out.println("Rx byte: " + Integer.toString(Byte.toUnsignedInt(d[0]),
		// 16));
		// System.out.println("Rx byte: " + Integer.toString(Byte.toUnsignedInt(d[1]),
		// 16));
	}
}
